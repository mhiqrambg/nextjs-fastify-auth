  ...
  return (
    <div className="space-y-4">
      <div className="flex w-full items-center justify-center">
        <Alert
          color="success"
          description="You have created class. Please click the button below to create a new class."
          endContent={
            <Button
              color="primary"
              as={Link as any}
              href="/dashboard/teacher/class-room/create"
            >
              + Class
            </Button>
          }
          title="You have created class"
          variant="faded"
        />
      </div>
        ...
        {classrooms.length === 0 ? (
          ...
          classrooms.map((classroom: TClassroom) => (
            <Card
              ...
              isPressable
              onPress={() =>
                router.push(`/dashboard/teacher/class-room/${classroom.id}`)
              }
